...
usernames: list = ["Admin", "MasterGabbro", "XxXMaestroXxX", "MaxPotenza"]
...
current_users: list = ["Admin", "Gabbrone", "UnFake", "ErDando", "Andrax", "MaxPotency"]

new_users: list = ["Il_Maestro", "Errapo", "Andrax", "MaxPotency"]

for i in new_users:

    if i in current_users:
        print("The username is not available, you'll have to use a different one.")
